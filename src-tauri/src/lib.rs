...
macro_rules! invoke_commands_with_extras {
    ($($extra:path),* $(,)?) => {
        ...
        // Agent Team runtime commands
        core::agent_runtime::ensure_agent_runtime,
        core::agent_runtime::agent_runtime_status,
        core::agent_runtime::stop_agent_runtime,
        // Server commands
        ...
        if let RunEvent::Exit = event {
            ...
            tokio::task::block_in_place(|| {
                tauri::async_runtime::block_on(async {
                    ...
                    crate::core::agent_runtime::cleanup_agent_runtime_processes().await;
